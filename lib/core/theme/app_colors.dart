...
class AppColors {
  ...
  // Semantic feedback colors (tint + foreground pairs)
  ...
  static const Color surface = Color(0xFFF6F9FF); // Dashboard canvas
  static const Color cardBackground = Colors.white;
  static const Color inputBackground = Color(0xFFF8FAFC);
  static const Color skeleton = Color(0xFFE9EEF6);
